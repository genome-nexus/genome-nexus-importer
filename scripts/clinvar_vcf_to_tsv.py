...
def __main__():
   ...
   parser.add_argument('clinvar_vcf', help='../data/clinvar/input/clinvar_grch37.vcf', default='../data/clinvar/input/clinvar_grch37.vcf')
   parser.add_argument('out_tsv', help='../data/clinvar/tsv/clinvar_grch37.tsv', default='../data/clinvar/tsv/clinvar_grch37.tsv')
