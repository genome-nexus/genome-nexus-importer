...
if __name__ == "__main__":
    ...
    parser.add_argument("ensembl_fasta",
                        help="./ensembl_grch37.fa")
    parser.add_argument("uniprot_id_with_sequence",
                        help="./uniprot_id_with_sequence.tab")
    ...
    main('/Users/lix2/Documents/GitHub/genome-nexus-importer/data/grch37_ensembl92/export/ensembl_biomart_transcripts.json', '/Users/lix2/Documents/GitHub/genome-nexus-importer/scripts/uniprot_mapping/ensembl_grch37.fa', '/Users/lix2/Documents/GitHub/genome-nexus-importer/scripts/uniprot_mapping/uniprot_id_with_sequence.tab', 'grch37')