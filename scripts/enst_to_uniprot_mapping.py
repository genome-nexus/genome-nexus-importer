...
# Output:
# "grch3x_enst_to_uniprot_mapping_full.txt" is the full spreadsheet generated by the script, it contains all review process columns
# "grch3x_enst_to_uniprot_mapping_id.txt" is the mapping file with only enst column and uniprot mapping column
