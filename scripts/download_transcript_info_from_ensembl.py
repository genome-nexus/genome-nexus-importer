...
if __name__ == "__main__":
    gene_info = pd.read_csv(sys.argv[1], sep='\t')
    ...
    tmp_dir = sys.argv[1].replace('input/ensembl_biomart_geneids.txt', 'tmp/transcript_info')
    ...
    # gene_transcript_info.to_csv('ensembl_biomart_geneids.transcript_info.txt', sep='\t', index=False)
